  ...
  const testimonials = [
    {
      ...
      quote:
        'Franchise Guru made finding the perfect business opportunity so easy! Their support team is amazing.',
    },
    {
      name: 'Rahul Verma',
      role: 'Investor',
      quote:
        'The platform’s verified listings gave me confidence to invest. Highly recommend!',
    },
  ];
    ...
    <main>
      ...
      >
        <div className="about-container">
          ...
          >
            Welcome to <strong>Franchise Guru</strong> — your trusted platform
            to discover verified franchise opportunities across India. Whether
            you're a budding entrepreneur or a seasoned investor, we’re here to
          ...
          >
            <h2>Our Mission</h2>
            <p>
              To empower individuals by simplifying the process of discovering
              and applying for franchise businesses. We aim to build a
              transparent, accessible, and growth-focused franchise ecosystem.
            </p>
          </motion.div>
          ...
          >
            ...
            <p>
              Aspiring entrepreneurs, investors, small business owners, or
              anyone looking to start or expand a business through franchising.
            </p>
          </motion.div>
            ...
            <div className="team-grid">
              <div className="team-card">
                ...
                <p>
                  ...
                  succeed in your franchise journey.
                </p>
              </div>
            </div>
          </motion.div>
